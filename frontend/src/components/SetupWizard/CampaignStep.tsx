...
export function CampaignStep({ campaignId }: Props) {
  const store = useGameStore()
  return (
    <div>
      <h2 style={{ marginBottom: 8 }}>Campaign Design</h2>
      <p style={{ color: '#6b7280', marginBottom: 16 }}>Work with the DM to shape your adventure.</p>
